...
<?php 
        //CHeck whether clothes id is set or not
        if(isset($_GET['clothes_id']))
        {
            //Get the clothes id and details of the selected clothes
            $clothes_id = $_GET['clothes_id'];

            //Get the DEtails of the SElected clothes
                ...
                <div class="clothes-menu-img">
                    <?php 
                            ...
                            else
                            {
                                //Image is Available
                                ?>
                    <img src="<?php echo SITEURL; ?>images/clothes/<?php echo $image_name; ?>" alt="Chicke Hawain Pizza"
        ...
        <?php 
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    if($res2==true)
                    {
                        ...
                        $_SESSION['order'] = "<div class='success text-center'>Clothes Ordered Successfully.</div>";
                        header('location:'.SITEURL);
                    }
                    else
                    {
                        //Failed to Save Order
                        $_SESSION['order'] = "<div class='error text-center'>Failed to Order clothes.</div>";
                        header('location:'.SITEURL);
                    }
